...
if __name__ == "__main__":
    ...
    #parser.add_argument("--images_root", default="./hw3_data/p2_data/images/val_t/", help="Image root")
    parser.add_argument("--annotation_file", default="p2_data/val.json", help="Annotation json file")
    #parser.add_argument("--annotation_file", default="./hw3_data/p2_data/val_t.json", help="Annotation json file")
